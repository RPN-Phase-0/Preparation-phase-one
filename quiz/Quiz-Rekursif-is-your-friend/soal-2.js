...
function changeXRecursive(data, jenis) {
    ...
    const shouldReplace = (jenis === 'ganjil' && firstNumber % 2 === 0) || (jenis === 'genap' && firstNumber % 2 !== 0);
    const replacedChar = shouldReplace ? 'x' : firstChar;

    return replacedChar + changeXRecursive(data.slice(1), jenis);
}
