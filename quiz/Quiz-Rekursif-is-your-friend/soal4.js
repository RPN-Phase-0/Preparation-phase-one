...
function dividableRecursive(array, num) {
  // Base case: Jika array kosong, kembalikan string kosong
  if (array.length === 0) return "";

  // Ambil elemen pertama dari array
  let first = array[0];
  // Cek apakah elemen pertama habis dibagi num
  let result = first % num === 0 ? first + " " : "";

  // Panggil rekursi dengan sisa elemen array
