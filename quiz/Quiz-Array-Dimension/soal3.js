...
cari nilai terbesar dalam arr
cek jarak setiap indeks nilai terbesar ke indek nilia besar lainnya
temudkan minimum distance
...
function minDistanceBetweenGreatest(arr) {
    ...
    for(let i = 0; i < arr.length; i++) {
      (arr[i] === largest) ? position.push(i) : null;
    }
