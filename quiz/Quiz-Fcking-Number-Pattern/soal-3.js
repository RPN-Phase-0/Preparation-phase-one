...
function squareNumber(num) {
  ...
  // Mengisi papan dengan urutan angka
  for (let i = 0; i < num; i++) {
    let row = [];
    // Mengisi row dari belakang ke depan untuk baris genap
    if (i % 2 === 0) {
      for (let j = 0; j < num; j++) {
      ...
      // Mengisi row dari depan ke belakang untuk baris ganjil
      for (let j = 0; j < num; j++) {
  ...
  // Mengubah urutan baris agar angka 1 berada di kolom paling bawah
  board.reverse();
