...
*/
  ...
  function virusCheckRecursive(str, viruses) {
    ...
    let virus = viruses.toLowerCase().split("|");

    let arr = str[0].toLowerCase();

    return ((virus.includes(arr)) ? 1 + virusCheckRecursive(str.substring(1), viruses) : virusCheckRecursive(str.substring(1), viruses))
  }
